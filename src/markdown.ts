import DICE_NAME_ID from './const/diceEmojiId'

export function bold(content: string): string {
	return `**${content}**`
}
export function emoji(emojiName: EmojiName): string {
	return `:${emojiName}: `
}

export function diceEmoji(emojiName: keyof typeof DICE_NAME_ID): string {
	return `<:${emojiName}:${DICE_NAME_ID[emojiName]}> `
}
